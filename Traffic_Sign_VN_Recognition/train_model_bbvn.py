...
from tf_keras.layers import Dropout, Flatten
...
for x in range(0, len(myList)):
    ...
    for y in myPicList:
        ...
        if curImg is not None:
            curImg = cv2.resize(curImg, (imageDimesions[0], imageDimesions[1]))  # Resize to 32x32
...
model.save("traffic_sign_model_final.h5")
